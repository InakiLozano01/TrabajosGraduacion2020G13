...
public class ControladorPrincipal {
    public static void main(String[] args) {
     ...
     //<editor-fold defaultstate="collapsed" desc="Sin intefaz gráfica"> 
        ...
        //ALUMNOS
        //PROFESORES
        Profesor profesor1 = new Profesor(10, Cargo.TITULAR, "Clave10", "Nombre10", "Apellidos10");
        Profesor profesor2 = new Profesor(20, Cargo.ASOCIADO, "Clave20", "Nombre20", "Apellidos20");
        Profesor profesor3 = new Profesor(30, Cargo.ADJUNTO, "Clave30", "Nombre30", "Apellidos30");
        Profesor profesor4 = new Profesor(40, Cargo.JTP , "Clave40", "Nombre40", "Apellido140");
        Profesor profesor5 = new Profesor(50, Cargo.ADG, "Clave50", "Nombre50", "Apellidos50");
        ...
        */
        ...
        Publicacion publicacion3 = new Publicacion("Título 3",mg3, fecha3 , tipos.get(0), idiomas.get(1), lugares.get(1), Arrays.asList(listaPalabras3), "Enlace 3", "Resumen 3");
        //PUBLICACION 3
        //PUBLICACION 4
